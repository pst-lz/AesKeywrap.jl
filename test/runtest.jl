...
function test_wrap_unwrap(kekstring, datastring, ivstring, cipherstring, test_name)
>>>>>>> 7b61c72e0920938713a0ce0aff1466d198d217c6
...
=======
    if  lowercase(bytes2hex(cipher)) == lowercase(cipherstring)
        println("Test \"$test_name\" part 1 (wrap) passed.")
    else
        println("Test \"$test_name\" part 1 (wrap) not passed.")
    end

    # unwrap
    plain = aes_unwrap_key(kek, cipherref, iv)
    if lowercase(bytes2hex(plain)) == lowercase(datastring)
        println("Test \"$test_name\" part 2 (unwrap) passed.")
    else
        println("Test \"$test_name\" part 2 (unwrap) not passed.")
    end
end
...
ivstring1 = "A6A6A6A6A6A6A6A6"
cipherstring1 = "1FA68B0A8112B447AEF34BD8FB5A7B829D3E862371D2CFE5"
test_wrap_unwrap(kekstring1, datastring1, ivstring1, cipherstring1, name1)
...
ivstring2 = "A6A6A6A6A6A6A6A6"
cipherstring2 = "96778B25AE6CA435F92B5B97C050AED2468AB8A17AD84E5D"
test_wrap_unwrap(kekstring2, datastring2, ivstring2, cipherstring2, name2)
...
ivstring3 = "A6A6A6A6A6A6A6A6"
cipherstring3 = "64E8C3F9CE0F5BA263E9777905818A2A93C8191E7D6E8AE7"
test_wrap_unwrap(kekstring3, datastring3, ivstring3, cipherstring3, name3)
...
ivstring4 = "A6A6A6A6A6A6A6A6"
cipherstring4 = "031D33264E15D33268F24EC260743EDCE1C6C7DDEE725A936BA814915C6762D2"
test_wrap_unwrap(kekstring4, datastring4, ivstring4, cipherstring4, name4)
...
ivstring5 = "A6A6A6A6A6A6A6A6"
cipherstring5 = "A8F9BC1612C68B3FF6E6F4FBE30E71E4769C8B80A32CB8958CD5D17D6B254DA1"
test_wrap_unwrap(kekstring5, datastring5, ivstring5, cipherstring5, name5)
...
ivstring6 = "A6A6A6A6A6A6A6A6"
cipherstring6 = "28C9F404C4B810F4CBCCB35CFB87F8263F5786E2D80ED326CBC7F0E71A99F43BFB988B9B7A02DD21"
test_wrap_unwrap(kekstring6, datastring6, ivstring6, cipherstring6, name6)
>>>>>>> 7b61c72e0920938713a0ce0aff1466d198d217c6
